...
class Ui_Options(QtGui.QDialog):
    def setupUi(self, Options):
        ...
        self.checkBox = QtGui.QCheckBox(Options)
        self.checkBox.setGeometry(QtCore.QRect(20, 40, 78, 20))
        self.checkBox.setObjectName(_fromUtf8("checkBox"))
        self.horizontalSlider = QtGui.QSlider(Options)
        ...
        self.lineEdit = QtGui.QLineEdit(Options)
        self.lineEdit.setGeometry(QtCore.QRect(120, 70, 391, 22))
        self.lineEdit.setObjectName(_fromUtf8("lineEdit"))
        self.toolButton = QtGui.QToolButton(Options)
